...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
       ...
       loadButton.disabled = true; 
        ...
        try {
            ...
            statusMessage.textContent = 'Restaurant data was loaded successfully'
            ...
            // YOUR CODE HERE:
            updateStatus('error',`Restaurant data could not be loaded`);
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            <strong>Uh oh, something is amiss...</strong>
            <p><strong>The restaruant data could not be loaded! This may be related to internet issues</strong></p>
